...
- Create markdown file of known objects:
    - `python generate_object_list.py known_objects/ > object_names.md`
- Create markdown file of all test objects:
    - `python generate_object_list.py test_objects/ > object_names.md`
...
- Or for individual tests if needed:
    - `python generate_object_list.py test_objects/example_test/ > object_names.md`
- Create pdf file from markdown file:
    - `pandoc object_names.md -o object_names.pdf`
